...
def main():
    ...
    lines[2:2] = ['> 本目录为早期跨科目分类草稿。文字・词汇（問題1—4）的正式分类及全量标签请使用[文字・词汇分类知识库](../N1考试知识库/文字词汇分类/README.md)，语法（問題5—7）全部期次的正式分类及标签请使用[语法分类知识库](../N1考试知识库/语法分类/README.md)。这些范围不再以本草稿标签作为分类依据。', '']
